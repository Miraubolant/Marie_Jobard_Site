...
export default function TestimonialEdit({ testimonial }: TestimonialEditProps) {
  ...
  return (
    <AdminLayout pageTitle="Modifier un témoignage - Administration">
              ...
              <div className="space-y-2">
                ...
                {testimonial.authorPhoto && (
                  <div className="mb-3">
                    ...
                    <p className="text-sm text-neutral-600 mt-2">Photo actuelle</p>
                  </div>
                )}
                <Input
                  id="authorPhoto"
                ...
                <p className="text-sm text-neutral-600">
                  ...
                  {testimonial.authorPhoto && ' (Laissez vide pour conserver la photo actuelle)'}
                </p>
