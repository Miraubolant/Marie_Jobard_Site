...
1. Start PostgreSQL with Docker Desktop
...
You should see `adonisjs_postgres` container running.
...
2. Create a database named `adonisjs_react_starter_kit_db`
...
- Docker Desktop (for PostgreSQL) OR PostgreSQL 12+ installed locally
